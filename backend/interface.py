...
def resource_information_list(course_id, number, category):
    ...
    if (category > 0): #add by ohazyi in 2018/3/2
        temp = list(Resource.objects.filter(course_code=course_id, category=category).values_list('id', 'upload_user_id','download_count','name', 'upload_time'))
